...
export default {
  ...
  async execute(msg, { sock, args, isOwner, settings }) {
    ...
    try {
      ...
      await sock.sendMessage(from, {
        text: '📥 *Pulling latest changes from GitHub...*\n\n🔗 Repository: GitHub.com/horlapookie/Horlapookie-xmd\n⏳ This may take a moment...'
      }, { quoted: msg });
      ...
      try {
        ...
        await execAsync('git clone https://github.com/horlapookie/Horlapookie-xmd.git temp_repo');
        await execAsync('cp -r temp_repo/* .');
        await execAsync('rm -rf temp_repo');
        await execAsync('git init');
        await execAsync('git remote add origin https://github.com/horlapookie/Horlapookie-xmd.git');
      }
